# Coffeescript on Heroku [![Dependency Status](https://gemnasium.com/WrongEntertainment/heroku-node-template.png)](https://gemnasium.com/WrongEntertainment/heroku-node-template)
